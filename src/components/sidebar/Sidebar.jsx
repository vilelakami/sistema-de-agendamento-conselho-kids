  ...
  return (
    <div className={`${styles.container} ${!expandida ? styles.fechada : ''}`}>
          ...
          <nav>
            <ul>
              <li>
                ...
                />
                {expandida && (
                  <Link className={styles.taskNav} to="/dashboard">
                    Dashboard
                  </Link>
                )}
              </li>
              ...
              <li>
                ...
                />
                {expandida && (
                  <Link className={styles.taskNav} to="/historico">
        ...
        <div className={styles.taskUsuario}>
          ...
          <ul>
            <li>
              ...
              {expandida && (
                <Link className={styles.taskNav} to="/configuracoes">
                  Configurações
                </Link>
              )}
            </li>
      ...
      <div className={styles.taskLogout}>
        ...
        {expandida && (
          <Link className={styles.taskNav} to="/login">
            Logout
          </Link>
        )}
      </div>
